...
function createOrg1() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: intermediatecerts/localhost-7054-ca-org1.pem
  ...
  set -x
  fabric-ca-client enroll -u http://peer1:peer1pw@localhost:7054 --caname ca-org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/msp --csr.hosts peer1.org1.example.com #--tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
  ...
  mkdir -p ${PWD}/crypto-config/peerOrganizations/org1.example.com/msp/tlsintermediatecerts
  cp ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org1.example.com/msp/tlsintermediatecerts/ca.crt

  mkdir -p ${PWD}/crypto-config/peerOrganizations/org1.example.com/tlsca
  cp ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem

  mkdir -p ${PWD}/crypto-config/peerOrganizations/org1.example.com/ca
  cp ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp/intermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem


  infoln "Generate the peer1-tls certificates"
  set -x
  fabric-ca-client enroll -u http://peer1:peer1pw@localhost:7054 --caname ca-org1 -M ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls --enrollment.profile tls --csr.hosts peer1.org1.example.com --csr.hosts localhost #--tls.certfiles ${PWD}/crypto-config/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null

  cp ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
...
function createOrg2() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: intermediatecerts/localhost-8054-ca-org2.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: intermediatecerts/localhost-8054-ca-org2.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generate the peer1 msp"
  set -x
  fabric-ca-client enroll -u http://peer1:peer1pw@localhost:8054 --caname ca-org2 -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp --csr.hosts peer1.org2.example.com #--tls.certfiles ${PWD}/crypto-config/fabric-ca/org2/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  cp ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
  ...
  mkdir -p ${PWD}/crypto-config/peerOrganizations/org2.example.com/msp/tlsintermediatecerts
  cp ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org2.example.com/msp/tlsintermediatecerts/ca.crt
  ...
  cp ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/ca.crt
...
function createOrderer() {
  ...
  Enable: true
  ClientOUIdentifier:
    Certificate: intermediatecerts/localhost-9054-ca-orderer.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: intermediatecerts/localhost-9054-ca-orderer.pem
    OrganizationalUnitIdentifier: peer
  ...
  cp ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/ca.crt
  ...
  mkdir -p ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlsintermediatecerts
  cp ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlsintermediatecerts/tlsca.example.com-cert.pem

  mkdir -p ${PWD}/crypto-config/ordererOrganizations/example.com/msp/tlsintermediatecerts
  cp ${PWD}/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/tlsintermediatecerts/* ${PWD}/crypto-config/ordererOrganizations/example.com/msp/tlsintermediatecerts/tlsca.example.com-cert.pem
