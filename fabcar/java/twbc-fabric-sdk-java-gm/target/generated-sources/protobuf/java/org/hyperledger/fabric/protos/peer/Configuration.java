...
public final class Configuration {
  ...
  public interface APIResourceOrBuilder extends
     ...
     * </pre>
     *
     * <code>optional string policy_ref = 1;</code>
     */
  ...
  public  static final class APIResource extends
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && getPolicyRef()
          .equals(other.getPolicyRef());
      return result;
    }
  ...
  public  static final class ACLs extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              acls = input.readMessage(
                  AclsDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              acls_.getMutableMap().put(acls.getKey(), acls.getValue());
              break;
            }
          }
        }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, org.hyperledger.fabric.protos.peer.Configuration.APIResource> entry
        ...
        com.google.protobuf.MapEntry<java.lang.String, org.hyperledger.fabric.protos.peer.Configuration.APIResource>
        acls = AclsDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(1, acls);
      }
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && internalGetAcls().equals(
